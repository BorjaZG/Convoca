...
const EVENTS_DATA = [
  // ── Pasados (status COMPLETED) ─────────────────────────────────────────────
  {
    ...
    description:
      'Una noche mágica con los mejores músicos de jazz de la escena madrileña bajo las estrellas del Parque del Retiro.',
  ...
  },
  {
    ...
    description:
      'Muestra temporal de obras de artistas emergentes del panorama nacional e internacional. Entrada libre para menores de 18 años.',
  ...
  },
  {
    ...
    description:
      'Aprende a preparar sushi, ramen y gyozas con el chef Hiroshi Tanaka. Incluye degustación y recetario exclusivo.',
  ...
  },
  {
    ...
    description:
      'Más de 80 artesanos locales presentan sus creaciones únicas: cerámica, textiles, joyería y gastronomía tradicional.',
  ...
  },
  {
    ...
    description:
      'La obra más universal de Shakespeare interpretada por la Compañía Nacional de Teatro Clásico en versión de David Toscano.',
  ...
  },
  {
    ...
    description:
      'Corre con nosotros en favor de la Asociación Española contra el Cáncer. Recorrido urbano de 10 km por el centro histórico de Valencia.',
  ...
  // ── Futuros (status PUBLISHED) ─────────────────────────────────────────────
  {
    ...
    description:
      'Tres días con los mejores artistas del flamenco contemporáneo. Actuaciones al aire libre, talleres y exposiciones fotográficas.',
    category: Category.CONCIERTO,
    startDate: future(15),
    endDate: future(17),
  ...
  },
  {
    ...
    description:
      'Fotógrafos de 20 países retratan la vida cotidiana en las grandes metrópolis. Una reflexión visual sobre el espacio urbano y sus habitantes.',
    category: Category.EXPOSICION,
    startDate: future(7),
    endDate: future(35),
  ...
  },
  {
    ...
    description:
      'Descubre la ancestral técnica japonesa del Raku. Crearás tu propia pieza y te la llevarás a casa. Nivel: principiantes bienvenidos.',
    category: Category.TALLER,
    startDate: future(10),
    endDate: future(10),
  ...
  },
  {
    ...
    description:
      'Ponentes de Google, Mistral AI y el MIT debatirán sobre el impacto de la inteligencia artificial en los mercados laborales. Mesa redonda incluida.',
  ...
  },
  {
    ...
    description:
      'Pintxos, txakoli y cocina de autor. Los mejores restaurantes del País Vasco se reúnen en una experiencia gastronómica única.',
  ...
  },
  {
    ...
    description:
      'El mercado más tradicional de Madrid con más de 100 puestos de artesanía, decoración navideña y productos gourmet de temporada.',
    category: Category.MERCADILLO,
    startDate: future(30),
    endDate: future(45),
    venue: 'Plaza Mayor',
  ...
  const REVIEWS = [
    {
      ...
      rating: 5,
      comment:
        'Una noche increíble, la acústica del Retiro es perfecta. Los músicos estuvieron soberbios.',
    },
    {
      eventId: eArte,
      userId,
      rating: 4,
      comment:
        'Selección de obras muy interesante. Eché de menos más artistas locales pero en conjunto impresionante.',
    },
    {
      eventId: eCocina,
      userId,
      rating: 5,
      comment:
        'El chef Hiroshi es un genio. Aprendí más en 3 horas que en años viendo vídeos. Totalmente recomendable.',
    },
    {
      eventId: eMercado,
      userId,
      rating: 3,
      comment:
        'Ambiente muy bueno y artesanía de calidad, aunque había demasiada gente y resultó difícil moverse.',
    },
    {
      eventId: eTeatro,
      userId,
      rating: 4,
      comment:
        'Puesta en escena magnífica y la interpretación de Hamlet fue memorable. La segunda parte se hizo algo larga.',
    },
    {
      eventId: eMaraton,
      userId,
      rating: 5,
      comment:
        'Organización impecable y ambiente solidario contagioso. Repetiré el año que viene sin dudarlo.',
    },
    {
      eventId: eJazz,
      userId: adminId,
      rating: 4,
      comment:
        'Gran nivel musical y muy buen ambiente. La ubicación en el parque le da un toque especial único.',
    },
    {
      eventId: eArte,
      userId: adminId,
      rating: 3,
      comment:
        'Interesante propuesta aunque algunas obras resultaron demasiado herméticas para el público general.',
    },
  ];
